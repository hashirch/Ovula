...
class ModelType(Enum):
    ...
    OLLAMA_DEEPSEEK_SMALL = "ollama_deepseek_small"
...
class Config:
    ...
    OLLAMA_DEEPSEEK_MODEL = os.getenv("OLLAMA_DEEPSEEK_MODEL", "deepseek-r1:7b")
    OLLAMA_DEEPSEEK_SMALL_MODEL = os.getenv("OLLAMA_DEEPSEEK_SMALL_MODEL", "deepseek-r1:1.5b")
    ...
    # ML Model Path
    ML_MODEL_PATH = os.getenv("ML_MODEL_PATH", os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(__file__)))), 'ml-models', 'models', 'saved', 'pcos_model.pkl'))
    ...
    def get_model_config(cls):
        ...
        return {
            ...
            "deepseek_model": cls.OLLAMA_DEEPSEEK_MODEL,
